...
<div class="row">
<div class="col-md-8">
<form action="{{ route('students.update', $studentData->id_student) }}" method="POST">
    @csrf
    @method('PUT')
    <input type="hidden" name="id_student" value="{{ $studentData->id_student }}">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                required value="{{ $studentData->name }}">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                required value="{{ $studentData->age }}">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                checked @if($studentData->gender != 'F') checked @endif>Male</label>
                <label class="radio-inline"><input type="radio" name="gender" value="F"
                @if($studentData->gender == 'F') checked @endif>Female</label>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <select name="id_teacher" class="form-control" required>
                    ...
                    @foreach ($teachersList as $teacher)
                        ...
                        @if($studentData->id_teacher == $teacher->id_teacher) selected 
